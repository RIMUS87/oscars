...
const orders = {
  ...
  'awards': ['one-battle-after-another', 'sinners', 'frankenstein', 'kpop-demon-hunters', 'wicked', 'a-friend-of-dorothy', 'all-the-empty-rooms', 'arco', 'armed-only-with-a-camera-the-life-and-death-of-brent-renaud', 'avatar-fire-and-ash', 'blue-moon', 'bugonia', 'butchers-stain', 'butterfly', 'children-no-more-were-and-are-gone', 'come-see-me-in-the-good-light', 'cutting-through-rocks', 'diane-warren-relentless', 'elio', 'f1', 'forevergreen', 'hamnet', 'if-i-had-legs-id-kick-you', 'it-was-just-an-accident', 'jane-austens-period-drama', 'jurassic-world-rebirth', 'kokuho', 'little-amelie-or-the-character-of-rain', 'marty-supreme', 'mr-nobody-against-putin', 'perfectly-a-strangeness', 'retirement-plan', 'sentimental-value', 'sirat', 'song-sung-blue', 'the-alabama-solution', 'the-devil-is-busy', 'the-girl-who-cried-pearls', 'the-lost-bus', 'the-perfect-neighbor', 'the-secret-agent', 'the-singers', 'the-smashing-machine', 'the-three-sisters', 'the-ugly-stepsister', 'the-voice-of-hind-rajab', 'train-dreams', 'two-people-exchanging-saliva', 'viva-verdi', 'weapons', 'zootopia-2']
};
